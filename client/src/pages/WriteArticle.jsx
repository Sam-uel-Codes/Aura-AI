...
const WriteArticle = () => {
  ...
  return (
    <div className="h-full overlow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      {/*Have to display in 2 columns*/}
      {/*Left-column*/}
    ...
    `}
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200 min-h-96 max-h-[600px]">
        <div className="flex items-center gap-3">
          <Edit className="w-5 h-5 text-[#4A7AFF] cursor-pointer" />
